/**
 * Ferrix — Engineering Intelligence types.
 * Aligned with the F-EIR (Ferrix Engineering Intermediate Representation) model:
...
/** A Ferrix finding (Gate 11 — finding quality). */
