    ...
    >
      ...
      <DialogContent className={size === 'lg' ? 'max-w-2xl' : 'max-w-xl'}>
        <DialogHeader>
          ...
          <DialogDescription>
            Grounded in structured Ferrix evidence — the AI cannot override or re-label it.
          </DialogDescription>
        </DialogHeader>
