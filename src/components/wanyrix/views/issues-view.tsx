...
import { useIssues } from '@/lib/wanyrix/hooks'
import type { IssueItem } from '@/lib/wanyrix/types'
        ...
        <Panel title="Traceability board unavailable">
          <div className="flex flex-col items-start gap-3">
            <p className="text-sm text-red-300">
              Failed to load issues from <span className="font-mono">/api/wanyrix/issues</span>.
            </p>
