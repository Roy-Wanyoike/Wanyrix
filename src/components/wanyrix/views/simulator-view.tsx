...
import { useGraph, useImpact } from '@/lib/wanyrix/hooks'
      ...
      <Dialog open={pending !== null} onOpenChange={(o) => !o && setPending(null)}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Wanyrix never modifies your repository silently. A reviewable diff will be proposed (Gate 19).
            </DialogDescription>
          </DialogHeader>
  ...
  return (
    <div className="space-y-5">
      ...
      <p className="font-mono text-[11px] text-muted-foreground">
        All figures estimated (Gate 21) · wanyrix experiment converts estimates into measured, verified results.
      </p>
    </div>
  )
}
