...
/**
 * Engineering Graph view (ViewId: 'graph', AUDIT-I3 required surface "Graph").
 * Band-layout dependency backbone + duplicates + blast radius. Previously this
 * file was named dependencies-view.tsx; it was renamed so the Dependencies
 * surface (ViewId: 'dependencies') could get its own first-class view.
 */
