...
import { useExperiments } from '@/lib/wanyrix/hooks'
import type { Experiment } from '@/lib/wanyrix/types'
        ...
        <Panel title="Experiments unavailable">
          <div className="flex flex-col items-start gap-3">
            <p className="text-sm text-red-300">
              Failed to load experiments from <span className="font-mono">/api/wanyrix/experiments</span>.
            </p>
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-start">
            <div className="flex flex-1 flex-col items-start gap-3">
              <p className="max-w-2xl text-[13px] leading-relaxed text-muted-foreground">
                Wanyrix never claims an improvement without a measured baseline/candidate pair. Run{' '}
                <span className="font-mono text-foreground/85">wanyrix doctor</span> for this workspace, pick a finding
            ...
            >
              <div className="flex items-center gap-1.5 border-b border-border/60 bg-black/30 px-3 py-1.5 text-[10px] text-muted-foreground">
                ...
                <span className="ml-1.5">wanyrix experiment — awaiting first run</span>
              </div>
              <div className="space-y-1 px-3 py-2.5">
                <p className="text-muted-foreground">$ wanyrix experiment start FER-…</p>
