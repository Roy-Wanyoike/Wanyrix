...
experiment · events · ai · git · impact · what-changed · export · sync · activate · entitlement · license`. Every engine command emits a versioned JSON
...
`wanyrix.impact/v1`, `wanyrix.what-changed/v1`, `wanyrix.export/v1`, `wanyrix.sync/v1`,
