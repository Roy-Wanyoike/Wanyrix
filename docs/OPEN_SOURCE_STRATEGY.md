...
| Web platform (dashboard UI, API routes) | **Open** (dual) | Shipped, verified (584-test suite: 577 pass / 4 counted skip — measured 2026-09-22) | The demonstrator; runs locally, no telemetry |
